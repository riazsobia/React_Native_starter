    ...
    render() {
        return (
            <View style={styles.container}>
                <TouchableOpacity style={styles.lead} onPress={() =>  this.props.navigation.navigate("DrawerOpen")}>
                    ...
                    <View style={styles.leadDetail}>
                        <Text style={{}}><MaterialIcons style={{color: 'steelblue'}} name='query-builder' size={10}/> 10:30 AM</Text>
                ...
                <View style={styles.lead}>
                    ...
                    <View style={styles.leadName}>
                        <Text style={{fontWeight: 'bold'}}>AIA Engineering</Text>
                        <Text>John Doe</Text>
                        <Text>Branch Manager</Text>
                    </View>
                    <View style={styles.leadDetail}>
                        <Text style={{}}><MaterialIcons style={{color: 'steelblue'}} name='query-builder' size={10}/> 4:30 AM</Text>
                ...
                <View style={styles.lead}>
                    ...
                    <View style={styles.leadName}>
                        <Text style={{fontWeight: 'bold'}}>Gala Infrastructure</Text>
                        <Text>Mark</Text>
                        <Text>Sales Manager</Text>
                    </View>
                    <View style={styles.leadDetail}>
                        <Text style={{}}><MaterialIcons style={{color: 'steelblue'}} name='query-builder' size={10}/> 4:30 PM</Text>
                        <TouchableOpacity style={styles.greenbutton} onPress={null}>
                            <Text style={{color: 'white'}}>Cold</Text>
                        </TouchableOpacity>
                        <Text style={{color: 'steelblue'}}>9843256029</Text>
                    </View>
                </View>
